...
var canvas;
var context;
var canvasWidth = <?php echo $width+400; ?>;
var canvasHeight = <?php if($height<=200) echo '200'; else  echo $height; ?>;
var padding = 25;
var lineWidth = 8;
...
var drawingAreaX = 114;
var drawingAreaY = 11;
var drawingAreaWidth = <?php echo $width; ?>;
var drawingAreaHeight =  <?php echo $height; ?>;
...
function prepareCanvas()
{
	...
	outlineImage.src = "<?php echo $limage; ?>";
...
function redraw()
{
	...
	if(curTool == "crayon")
	{
		...
		context.drawImage(crayonBackgroundImage,<?php echo $width+112?>, 0, 100, 212);
	...
	else if(curTool == "marker")
	{
		...
		context.drawImage(markerBackgroundImage, <?php echo $width+112?>, 0, 100, 212);
	...
	{
		context.drawImage(eraserBackgroundImage, <?php echo $width+112?>, 0, 100, 212);
	...
	if(curSize == "small"){
		locX = drawingAreaWidth+190;
	}else if(curSize == "normal"){
		locX = drawingAreaWidth+175;
	}else if(curSize == "large"){
		locX = drawingAreaWidth+156;
	}else if(curSize == "huge"){
		locX = drawingAreaWidth+130;
	}
	locY = 189;
	context.beginPath();
